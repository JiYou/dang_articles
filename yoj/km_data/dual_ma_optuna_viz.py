...
def main():
    ...
    study.optimize(objective, n_trials=200, n_jobs=-1) # 使用所有CPU核心并行计算
    ...
    #    if "buy" in action or "cover" in action:
    #        plt.scatter(d, price, marker="^", color="green", s=50, zorder=5)
    #    else:
    #        plt.scatter(d, price, marker="v", color="red", s=50, zorder=5)
    ...
    # 6. Plotly 可视化优化过程
    print("Displaying Optuna optimization history and parameter importances...")
